jQuery.sap.declare("com.ffa.hpc.view.dataset.ViewHDB");
...
sap.ui.define(["jquery.sap.global", "com/ffa/hpc/view/data/ViewController"],
  function(jQuery, Controller) {
    ...
    var HDB = Controller.extend("com.ffa.hpc.view.dataset.ViewHDB", /** @lends com.ffa.hpc.view.dataset.ViewHDB.prototype */ {
      _editMode: false
    });

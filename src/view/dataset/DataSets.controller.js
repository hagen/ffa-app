jQuery.sap.declare("com.ffa.hpc.view.dataset.DataSets");
...
sap.ui.define(['jquery.sap.global', 'com/ffa/hpc/view/data/Controller'],
  function(jQuery, Controller) {
    ...
    var DataSets = Controller.extend("com.ffa.hpc.view.dataset.DataSets", /** @lends com.ffa.hpc.view.dataset.DataSets.prototype */ {
    ...
    DataSets.prototype.onMasterDeletePress = function(oEvent) {
      ...
      if (!d) {
        this._oDeletionDialog = d = sap.ui.xmlfragment("idDeletionFragment", "com.ffa.hpc.view.dataset.DeletionListDialog", this);

jQuery.sap.declare("com.ffa.hpc.view.dataset.CreateController");
...
sap.ui.define(["jquery.sap.global", "com/ffa/hpc/view/data/Controller"],
  function(jQuery, DataController) {
    ...
    var Controller = DataController.extend("com.ffa.hpc.view.dataset.CreateController", /** @lends com.ffa.hpc.view.dataset.CreateController */ {
      _sId: "",
      _oLink: null,
      _aLinks: []
    });
    ...
    Controller.prototype.onDefinitionLinkPress = function(oEvent) {
      ...
      if (!this._oDefinitionDialog) {
        this._oDefinitionDialog = sap.ui.xmlfragment("idDataTypeFragment", "com.ffa.hpc.view.dataset.DimensionDataTypeDialog", this);

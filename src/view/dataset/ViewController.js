jQuery.sap.declare("com.ffa.hpc.view.dataset.ViewController");
...
sap.ui.define(["jquery.sap.global", "com/ffa/hpc/view/data/Controller"],
  function(jQuery, DataController) {
    ...
    var Controller = DataController.extend("com.ffa.hpc.view.dataset.ViewController", /** @lends com.ffa.hpc.view.dataset.ViewController */ {

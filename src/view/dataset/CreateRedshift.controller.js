jQuery.sap.declare("com.ffa.hpc.view.dataset.CreateRedshift");
...
sap.ui.define(["jquery.sap.global", "com/ffa/hpc/view/data/CreateController"],
  function(jQuery, Controller) {
    ...
    var Redshift = Controller.extend("com.ffa.hpc.view.dataset.CreateRedshift", /** @lends com.ffa.hpc.view.dataset.CreateRedshift.prototype */ {
      ...
      this.getView().getModel("dataset").create("/Redshift", this.getData(), {
        success: jQuery.proxy(function(oData, mResponse) {
          ...
          oTable.bindItems({
            ...
            template: sap.ui.xmlfragment("com.ffa.hpc.view.dataset.SchemaField", this)
          });

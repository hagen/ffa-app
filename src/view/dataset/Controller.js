jQuery.sap.declare("com.ffa.hpc.view.dataset.Controller");
...
sap.ui.define(["jquery.sap.global", "com/ffa/hpc/util/Controller"],
  function(jQuery, UtilController) {
    ...
    var Controller = UtilController.extend("com.ffa.hpc.view.dataset.Controller", /** @lends com.ffa.hpc.view.dataset.Controller */ {

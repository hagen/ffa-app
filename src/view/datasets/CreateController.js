jQuery.sap.declare("com.ffa.hpc.view.datasets.CreateController");
...
sap.ui.define(["jquery.sap.global", "com/ffa/hpc/view/datasets/Controller"],
  function(jQuery, DataController) {
    ...
    var Controller = DataController.extend("com.ffa.hpc.view.datasets.CreateController", /** @lends com.ffa.hpc.view.datasets.CreateController */ {
      _sId: "",
      _oLink: null,
      _aLinks: []
    });
